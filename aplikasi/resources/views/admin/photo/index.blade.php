                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{ Storage::url('public/images/'.$photo->image) }}" style="width: 150px"></td>
                                    <td>{{ $photo->caption }}</td>
                                    <td class="text-center">
                                        @can('photos.delete')
                                        <button onClick="deletePhoto({{ $photo->id }})" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></button>
                                        @endcan
                                    </td>
                                </tr>
                                @endforeach
    ...
    function deletePhoto(id) {
        ...
        swal({
            ...
            if (isConfirm) {
                //ajax delete
                $.ajax({
                    url: "{{ route('admin.photos.index') }}/" + id,
                    data: {
                        "_token": token,
                        "_method": "DELETE"
                    },
